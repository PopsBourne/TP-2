...
public class MapaCarreteras {
	...
	public MapaCarreteras() {
		...
		mapaDeCruces = new HashMap<String, Cruce>();
		mapaDeVehiculos = new HashMap<String, Vehiculo>();
		
	}

	public void addCruce(String idCruce, Cruce cruce) throws Existe {
	...
	public void addVehiculo(String idVehiculo, Vehiculo vehiculo) throws Existe {
		...
		if (!mapaDeVehiculos.equals(idVehiculo)) {
	...
	public void addCarretera(String idCarretera, Cruce origen, Carretera carretera, Cruce destino) throws Existe {
	...
	public String generateReport(int time) {
		String report = "";
		Iterator<Cruce> it = cruces.iterator();
		while(it.hasNext()){
	...
	public Cruce getCruce(String id) throws NoExiste {
